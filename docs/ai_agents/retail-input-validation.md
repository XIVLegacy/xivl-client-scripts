...
| Input coordinate | `XIVLegacy/xivl-retail-client-inputs` |

The input grant pins `battle-command-baseclass-lpb-1.23b` to commit
`abfddb3e8434af4ae36d55269088e489cc8050e5`, its exact repository-relative
...
`XIVLegacy/xivl-retail-client-inputs`; the environment secret is
